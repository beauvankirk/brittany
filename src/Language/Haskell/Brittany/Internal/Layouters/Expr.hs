    ...
    RecordCon lname _ _ fields ->
      ...
      case fields of
        ...
        (HsRecFields fs@(_:_) Nothing) -> do
          ...
          ((fd1l, fd1n, fd1e):fdr) <- fs `forM` \fieldl@(L _ (HsRecField (L _ fieldOcc) fExpr pun)) -> do
#if MIN_VERSION_ghc(8,6,0)   /* ghc-8.6 */
...
#if MIN_VERSION_ghc(8,6,0)   /* ghc-8.6 */
    RecordUpd _ rExpr fields ->
#else
    RecordUpd rExpr fields _ _ _ _ ->
#endif
      case fields of
        [] -> do
